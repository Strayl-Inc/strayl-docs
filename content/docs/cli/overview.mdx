...
# Clone an existing Strayl project (auto-checks out dev)
st clone username/my-project
cd my-project

# Or create a new Strayl project from an existing git repository
st init
...
| `st clone <username/repo>` | Clone a Strayl repository (auto-checks out dev) |
